...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        service.loadFromJSON(FILE_NAME);
        ...
        while (running) {
            ...
            System.out.println("2. File Settings");
            ...
            switch (mainChoice) {
                case "1":
                    manageContactsMenu(service, scanner);
                    break;
                case "2":
                    fileSettingsMenu(service, scanner);
                    break;
                case "0":
                    service.saveToJSON(FILE_NAME);
                    running = false;
    ...
    private static void manageContactsMenu(PhonebookService service, Scanner scanner) {
    ...
    private static void fileSettingsMenu(PhonebookService service, Scanner scanner) {
        boolean inSubMenu = true;
        while (inSubMenu) {
            System.out.println("\n--- FILE SETTINGS ---");
            System.out.println("1. Save to JSON");
